...
.const
text        SZWSTR("%i")
timestr     SZWSTR("%i:%i:%i")

.data
boardfont   LOGFONTW < 0, 0, 0, 0, FW_MEDIUM, FALSE, FALSE, FALSE, ANSI_CHARSET, \
                     OUT_OUTLINE_PRECIS, CLIP_DEFAULT_PRECIS, PROOF_QUALITY, \
                     FIXED_PITCH  or FF_ROMAN, <SZWSTRL("Times New Roman")> >
                        
timefont    LOGFONTW < 0, -9, 0, 0, FW_THIN , FALSE, FALSE, FALSE, ANSI_CHARSET, \
                     OUT_OUTLINE_PRECIS, CLIP_DEFAULT_PRECIS, PROOF_QUALITY, \
                     FIXED_PITCH  or FF_DECORATIVE, <SZWSTRL("DigifaceWide")> >   
...
DisplayText   PROC 
    local srect:RECT, szbuffer[16]:byte, hfont:HFONT
...
DisplayTime PROC 
    local szbuffer[32]:byte, hfont:HFONT
