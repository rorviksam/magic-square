...
BestDlgProc PROC hDlg:DWORD, UMsg:DWORD, wParam:DWORD, lParam:DWORD
    ...
    local szBuffer[30]:byte     ; Hold formatted string
    ...
    L1:
        ...
        mov     hEdit,  eax
        invoke  GetWindowText, hEdit, addr szFormat, 80
        movzx   ecx,    t.hours
        movzx   ebx,    t.minutes
        movzx   eax,    t.seconds
...
EditDlgProc PROC hDlg:DWORD, UMsg:DWORD, wParam:DWORD, lParam:DWORD
    ...
    .if eax == WM_INITDIALOG
        ...
        mov     hEdit,  eax
        invoke  GetWindowText, hEdit, addr szFormat, 30
    ...
    .elseif eax == WM_COMMAND
        ...
        .if wParam == IDOK
            ...
            invoke  RegSetValueEx, MKey, temp3, 0, REG_DWORD, addr time,4
            invoke  EndDialog, hDlg, 0
            mov     eax,    TRUE
            ret
        .endif    
